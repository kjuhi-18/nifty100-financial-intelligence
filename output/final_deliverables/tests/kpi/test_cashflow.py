...
def test_cfo_quality_high():
    ...
    result = cfo_quality_score([500, 520, 540, 560, 600], [400, 420, 430, 450, 500])
...
def test_cfo_quality_insufficient():
    ...
    result = cfo_quality_score([100], [100])
...
def test_capex_intensity():
    ...
    result = capex_intensity(-100, 1000)
...
def test_fcf_conversion():
    ...
    assert fcf_conversion_rate(300, 150) == 200.0
...
def test_capital_allocation():
    ...
    assert capital_allocation_pattern(500, -100, -50) == "Reinvestor"
...
def test_distress():
    ...
    assert distress_signal(-100, 50)


def test_not_distress():

    assert not distress_signal(100, -50)
...
def test_deleveraging():
    ...
    assert deleveraging_flag(80, 100, -50)


def test_not_deleveraging():

    assert not deleveraging_flag(120, 100, -50)
